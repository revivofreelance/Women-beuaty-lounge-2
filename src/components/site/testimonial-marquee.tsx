  ...
  const cards = (
    <div className="flex shrink-0 gap-5 pr-5">
      {items.map((t) => (
        <figure
          key={t.id}
          className="flex w-[320px] shrink-0 flex-col rounded-2xl border border-border/70 bg-card shadow-sm transition-shadow hover:shadow-lg sm:w-[360px] p-3 md:p-4 lg:p-5"
        >
