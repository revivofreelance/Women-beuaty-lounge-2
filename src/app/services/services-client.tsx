...
export function ServicesClient() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* ============== SERVICES GRID ============== */}
      <section id="services-grid" className="bg-background py-6 md:py-8 lg:py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {filtered.length === 0 ? (
            <div className="mx-auto flex max-w-md flex-col items-center gap-4 rounded-3xl border border-dashed border-border/70 bg-secondary/30 px-6 text-center py-6 md:py-10 lg:py-16">
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 text-primary">
                <Search className="h-6 w-6" />
              </div>
              <h3 className="font-serif font-semibold text-foreground text-lg md:text-xl lg:text-2xl">No services found</h3>
                    ...
                    <Card className="h-full cursor-pointer overflow-hidden border-border/70 p-0 gap-0 transition-all duration-500 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-black/10">
                      ...
                      <div className="relative aspect-[16/10] overflow-hidden">
                        ...
                        <div className="absolute left-3 top-3 flex flex-wrap items-center gap-2">
                          <Badge className="rounded-full border border-background/20 bg-background/85 text-foreground backdrop-blur-sm hover:bg-background/85">
                            {s.category}
                          </Badge>
                          {s.popular && (
                            <Badge className="gap-1 rounded-full bg-salon-gold px-2.5 text-foreground shadow-sm">
                        ...
                        <div className="absolute bottom-3 left-3 flex items-center gap-2">
                          <span className="inline-flex items-center gap-1.5 rounded-full bg-background/85 px-2.5 py-1 text-xs font-medium text-foreground backdrop-blur-sm">
                            <Clock className="h-3 w-3 text-primary" />
                            {s.duration}
                          </span>
                          <span className="inline-flex items-center gap-1 rounded-full bg-background/85 px-2.5 py-1 text-xs font-medium text-foreground backdrop-blur-sm">
                      ...
                      <CardContent className="p-4 sm:p-5">
                        ...
                        <p className="mt-1.5 line-clamp-2 text-sm text-muted-foreground leading-snug md:leading-relaxed">
                          {s.shortDescription}
                        </p>
      ...
      <section className="bg-blush py-6 md:py-10 lg:py-12">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-5 px-4 text-center sm:px-6 lg:px-8">
          <Reveal className="flex flex-col items-center gap-5">
            ...
            <p className="max-w-xl text-pretty text-base text-muted-foreground leading-snug md:leading-relaxed">
