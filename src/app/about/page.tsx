...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* ============== FOUNDER'S MESSAGE ============== */}
      {founder && (
        <section className="bg-foreground text-background py-5 sm:py-6 md:py-10 lg:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid items-center lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
              ...
              <Reveal delay={120} className="lg:col-span-2">
                ...
                <blockquote className="mt-5 font-serif font-medium leading-snug text-base sm:text-lg md:text-xl lg:text-2xl">
                ...
                <div className="mt-6 flex flex-col gap-1">
                  <p className="font-serif text-sm font-semibold sm:text-lg">{founder.name}</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <Reveal className="mt-6 md:mt-10 flex flex-wrap justify-center gap-3">
            {brandsUsed.map((brand) => (
              <span
                key={brand}
                className="rounded-full border border-border/70 bg-card px-3 py-1.5 font-serif text-sm text-foreground sm:px-5 sm:py-2.5 sm:text-lg shadow-sm"
              >
                {brand}
              </span>
            ))}
      ...
      {/* ============== COMMUNITY ============== */}
      <section className="bg-background text-center py-5 sm:py-6 md:py-10 lg:py-16">
